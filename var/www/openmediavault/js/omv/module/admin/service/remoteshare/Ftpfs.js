...
Ext.define("OMV.module.admin.service.remoteshare.FtpShare", {
    ...
    rpcGetMethod : "getFtpShare",
    rpcSetMethod : "setFtpShare",
...
Ext.define("OMV.module.admin.service.remoteshare.FtpShares", {
    ...
    uses     : [
        "OMV.module.admin.service.remoteshare.FtpShare"
    ],
    ...
    onAddButton : function() {
        var me = this;
        Ext.create("OMV.module.admin.service.remoteshare.FtpShare", {
            title     : _("Add share"),
...
OMV.WorkspaceManager.registerPanel({
    ...
    text      : _("FTPFS"),
    position  : 60,
    className : "OMV.module.admin.service.remoteshare.FtpShares"
});
